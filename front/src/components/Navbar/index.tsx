...
const Navbar: React.FC<{isActive: boolean}> = ({isActive}) => {
  return (
    <div className={`fixed top-0 left-0 w-1/3 p-4 pl-4 h-24 border border-gray-500 rounded-xl bg-gray-50 shadow-md shadow-gray-500 transition-transform duration-500 ${isActive ? 'translate-y-0' : '-translate-y-full'}`}>
